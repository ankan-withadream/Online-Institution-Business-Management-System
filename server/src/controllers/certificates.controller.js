...
export const create = async (req, res) => {
  try {
    ...
    // Resolve user_id once for photo lookup
    ...
    if (existingCert) {
      const photoUrl = await resolveStudentPhotoDataUrl(userId);
...
export const verify = async (req, res) => {
  try {
    ...
    const photoUrl = await resolveStudentPhotoDataUrl(data.students?.user_id);
