...
CREATE TABLE franchises (
  ...
  state TEXT,
  pincode TEXT,
  has_building_or_rental TEXT,
  has_education_experience TEXT,
  course_categories TEXT[],
  course_ids UUID[],
  teaching_facility_details TEXT,
  classroom_facility_details TEXT,
...
CREATE INDEX idx_students_serial_number ON students(serial_number);
...
-- ─── MIGRATIONS: serial_number & registration_number ───
-- Both are independent auto-incrementing BIGINT identifiers
-- generated by the application (not DB sequences).
ALTER TABLE students
  ADD COLUMN IF NOT EXISTS serial_number BIGINT UNIQUE,
  ADD COLUMN IF NOT EXISTS registration_number BIGINT UNIQUE;
